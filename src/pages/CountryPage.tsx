        ...
        <Tabs defaultValue="plans" className="animate-fade-in">
          ...
          <TabsContent value="plans" className="space-y-8">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-purple-700 text-sm">Therefore claims are received on both reimbursement basis and direct settlement.</p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center mb-8">
              <div className="inline-block bg-purple-400 text-white px-8 py-3 rounded-full shadow-lg">
                            ...
                            <Dialog>
                              ...
                              <DialogContent className="max-w-4xl">
                                ...
                                <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
                                  <iframe
                                    src={plan.id.includes('standard') ? "https://player.vimeo.com/video/1022523801?title=0&byline=0&portrait=0&badge=0&autopause=0&player_id=0&app_id=58479" : "https://player.vimeo.com/video/1022529532?title=0&byline=0&portrait=0&badge=0&autopause=0&player_id=0&app_id=58479"}
                                    frameBorder="0"
